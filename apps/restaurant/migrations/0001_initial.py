    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('business_information', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='restaurant.businessinformation')),
                ('location', models.OneToOneField(on_delete=django.db.models.deletion.PROTECT, to='restaurant.location')),
            ],
        ),
    ]
